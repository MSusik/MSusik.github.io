...
<p>The main idea of Markdown is to use a simple plain text markup. It’s <s>hard</s> easy to <strong>make</strong> <strong>bold</strong> <em>or</em> <em>italic</em> text. Simple equations can be formatted with subscripts and superscripts: <em>E</em><sub>0</sub>=<em>mc</em><sup>2</sup>. I have added the LaTeX support: <img src="https://tex.s2cms.ru/svg/E_0%3Dmc%5E2" alt="E_0=mc^2" />.</p>
...
<p>Also the editor supports typographic replacements: © ® ™ § ± !!! ??? ,  – —</p>
<h2>LaTeX</h2>
<p>The editor converts LaTeX equations in double-dollars <code>$$</code>: <img src="https://tex.s2cms.ru/svg/ax%5E2%2Bbx%2Bc%3D0" alt="ax^2+bx+c=0" />. All equations are rendered as block equations. If you need inline ones, you can add the prefix <code>\inline</code>: <img src="https://tex.s2cms.ru/svg/%5Cinline%20p%3D%7B1%5Cover%20q%7D" alt="\inline p={1\over q}" />. But it is a good practice to place big equations on separate lines:</p>
<p align="center" style="text-align: center;"><img align="center" src="https://tex.s2cms.ru/svg/x_%7B1%2C2%7D%20%3D%20%7B-b%5Cpm%5Csqrt%7Bb%5E2%20-%204ac%7D%20%5Cover%202a%7D." alt="x_{1,2} = {-b\pm\sqrt{b^2 - 4ac} \over 2a}." /></p>
...
<p align="center" style="text-align: center;"><span style="float:right">(1)</span><img align="center" src="https://tex.s2cms.ru/svg/%7C%5Cvec%7BA%7D%7C%3D%5Csqrt%7BA_x%5E2%20%2B%20A_y%5E2%20%2B%20A_z%5E2%7D." alt="|\vec{A}|=\sqrt{A_x^2 + A_y^2 + A_z^2}." /></p>
<p>It is possible to write Cyrillic symbols in <code>\text</code> command: <img src="https://tex.s2cms.ru/svg/Q_%5Ctext%7B%D0%BF%D0%BB%D0%B0%D0%B2%D0%BB%D0%B5%D0%BD%D0%B8%D1%8F%7D%3E0" alt="Q_\text{плавления}&gt;0" />.</p>
<p>One can use matrices:</p>
<p align="center" style="text-align: center;"><img align="center" src="https://tex.s2cms.ru/svg/T%5E%7B%5Cmu%5Cnu%7D%3D%5Cbegin%7Bpmatrix%7D%0A%5Cvarepsilon%260%260%260%5C%5C%0A0%26%5Cvarepsilon%2F3%260%260%5C%5C%0A0%260%26%5Cvarepsilon%2F3%260%5C%5C%0A0%260%260%26%5Cvarepsilon%2F3%0A%5Cend%7Bpmatrix%7D%2C" alt="T^{\mu\nu}=\begin{pmatrix}
\varepsilon&amp;0&amp;0&amp;0\\
0&amp;\varepsilon/3&amp;0&amp;0\\
0&amp;0&amp;\varepsilon/3&amp;0\\
0&amp;0&amp;0&amp;\varepsilon/3
\end{pmatrix}," /></p>
<p>integrals:</p>
<p align="center" style="text-align: center;"><img align="center" src="https://tex.s2cms.ru/svg/P_%5Comega%3D%7Bn_%5Comega%5Cover%202%7D%5Chbar%5Comega%5C%2C%7B1%2BR%5Cover%201-v%5E2%7D%5Cint%5Climits_%7B-1%7D%5E%7B1%7Ddx%5C%2C(x-v)%7Cx-v%7C%2C" alt="P_\omega={n_\omega\over 2}\hbar\omega\,{1+R\over 1-v^2}\int\limits_{-1}^{1}dx\,(x-v)|x-v|," /></p>
